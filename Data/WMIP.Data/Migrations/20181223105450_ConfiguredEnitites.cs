...
{
    public partial class ConfiguredEnitites : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    MusicVideoLink = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(nullable: true),
                    Comment_UserId = table.Column<string>(nullable: true),
                    CommentedOnId = table.Column<int>(nullable: true),
                    ReviewScore = table.Column<int>(nullable: true),
                    AlbumId = table.Column<int>(nullable: true),
                    Review_UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_Posts_CommentedOnId",
