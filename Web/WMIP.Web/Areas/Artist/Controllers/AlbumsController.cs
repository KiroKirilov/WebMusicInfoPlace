...
namespace WMIP.Web.Areas.Artist.Controllers
{
    ...
    public class AlbumsController : Controller
    {
        ...
        public IActionResult Create(AlbumViewModel model)
        {
            ...
            var creationInfo = this.mapper.Map<CreateAlbumDto>(model);
            creationInfo.ArtistId = userId;

            var creationResult = this.albumsService.Create(creationInfo);
        ...
        public IActionResult Edit(int? id)
        {
            ...
            var userCanEditItem = this.albumsService.IsUserCreatorById(userId, id.Value);
        ...
        public IActionResult Edit(AlbumViewModel model)
        {
            ...
            var userCanEditItem = this.albumsService.IsUserCreatorById(userId, model.Id.Value);
            ...
            var editInfo = this.mapper.Map<EditAlbumDto>(model);

            var editResult = this.albumsService.Edit(editInfo);
        ...
        public IActionResult Delete(int? id)
        {
            ...
            var userIsCreator = this.albumsService.IsUserCreatorById(userId, id.Value);
        ...
        public IActionResult Delete(AlbumViewModel model)
        {
            ...
            var userIsCreator = this.albumsService.IsUserCreatorById(userId, model.Id.Value);
